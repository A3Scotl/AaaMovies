  ...
  return (
    <>
      <div className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-out ${
        ...
        <div className="w-full px-4 lg:px-10 py-4 flex justify-between items-center">          
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            {['Home', 'Movies', 'TV Shows', 'Web Series'].map((item, index) => (
              <a
                key={index}
                href="#"
      ...
      <div className={`fixed inset-0 z-40 lg:hidden transition-all duration-500 ${
        ...
        {/* Menu Content */}
        <div className={`absolute top-20 right-4 w-64 bg-gray-900/95 backdrop-blur-md rounded-2xl border border-red-500/20 shadow-2xl transform transition-all duration-500 ${
